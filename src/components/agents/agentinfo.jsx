...
import EditAgentModal from "./modals/edit_agent";
...
export default function AgentInfo(props) {
  ...
  return (
    <>
      ...
      <main className="main-content page-bg" id="main-content">
        <div className="box customer-info coutomerAccount-wrap">
          ...
          <div className="ca-top d-flex justify-content-between my-3">
            ...
            <div className="left">
              <button className="fancybox btn-aid" data-bs-toggle="modal" data-bs-target="#addAgentModal" onClick={() => validateAdmistModels()}>
                {" "}
                New Agent{" "}
              </button>
            </div>
          ...
          <div className="ca-info">
            ...
            <div className="btn-wrap d-flex justify-content-between">
              <div className="left">
                <button type="button" data-bs-toggle="modal" data-bs-target="#EditAgentModal" onClick={() => validateAdmistModels()} disabled={dataGridRows && dataGridRows.id === undefined ? true : false}>
                  Edit User
                </button>
                &nbsp;
              </div>
      ...
      {dataGridRows ? (
        <>
          <EditAgentModal userData={dataGridRows} />
          <ChangePasswordModal userData={dataGridRows} />
          <AddAgentModal userData={dataGridRows} />
        </>
      ) : (
        ""
      )}
