...
export default function BatchEditAgent(props) {
  ...
  return (
    <>
      ...
      <div className="modal fade" id="batchEditagent" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="batchEditagentLabel" aria-hidden="true">
        <div className="modal-dialog modal-dialog-centered modal-lg">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title" id="batchEditagentLabel">
                Batch Edit
              </h5>
