      ...
      apiPost(url, params)
        .then((response) => {
          ...
          if (parseInt(response.data.code) === 200) {
            ...
            document.getElementById("close_model_edit").click();
            navigate("/adminstratorinfo/" + props.userData.id);
          } else {
          ...
          <div className="modal-content">
            ...
            <form className="p-1" action="" onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="modal-footer">
                ...
                <button type="button" onClick={closePopup} className="btn bg-gradient-danger" data-bs-dismiss="modal" id="close_model_edit">
                  Cancel
                </button>
              </div>
            </form>
