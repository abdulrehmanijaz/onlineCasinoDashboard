...
export default function EditUserModal(props) {
  ...
  useEffect(
    ...
    validateToken();
  },[props,props.setDataGridLoading,isSubmitSuccessful,setValue]);
  ...
  const onSubmit = (formData) =>{
        ...
        if(parseInt(response.data.code) === 200){
          ...
          props.apiRef.current.updateRows([
            { id: props.userData.id, 
              ...
              is_status: parseInt(response.data.data.is_active) === 1 ? 'Active' : 'Suspend'
            }
          ]);
          props.setDataGridLoading(false)
          let link = document.querySelector(`div[data-id='${props.userData.id}']`);
          link.setAttribute('style', 'background: rgb(217 243 190)');
          setTimeout(function(){
    ...
    return (
      <>
        ...
        <div className="modal fade" id="editUserModal" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false"  aria-labelledby="editUserModalLabel" aria-hidden="true">
            ...
            <div className="modal-content">
              ...
              <form className="p-1" action="" onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="modal-footer">
                  <button type="button" onClick={closePopup} className="btn bg-gradient-danger" data-bs-dismiss="modal" id="close_model">Cancel</button>
