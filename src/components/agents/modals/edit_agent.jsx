...
export default function EditAgentModal(props) {
      ...
      apiPost(url, params)
        .then((response) => {
          ...
          if (parseInt(response.data.code) === 200) {
            ...
            navigate("/agentInfo/" + props.userData.id);
          } else {
  ...
  return (
    <>
      ...
      <div className="modal fade" id="EditAgentModal" tabIndex="-1" data-bs-backdrop="static" data-bs-keyboard="false" aria-labelledby="editAgentModalLabel" aria-hidden="true">
        <div className="modal-dialog modal-dialog-centered modal-lg">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title" id="editAgentModalLabel">
                {props.editUser}
              </h5>
