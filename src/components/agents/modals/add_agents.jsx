...
export default function AddAgentModal(props) {
      ...
      apiPost(url, params)
        .then((response) => {
          ...
          if (response.data.code === 200) {
            ...
            reset();
            navigate("/agentInfo/" + response.data.data.id);
          } else {
  ...
  return (
    <>
      ...
      <div className="modal fade" id="addAgentModal" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false" aria-labelledby="addAgentModalLabel" aria-hidden="true">
