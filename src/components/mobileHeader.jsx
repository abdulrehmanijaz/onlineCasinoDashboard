...
export default function MobileHeader({ show, setShow }) {
  ...
  return (
    <div id="mobile-header">
      {show && (
        <>
          <div className="back-drop " onClick={() => setShow(!show)}></div>
          <aside className="sidenav p-0" id="sidenav-main">
            <div className="sidenav-header">
              <div className="close-btn btn text-danger " onClick={() => setShow(!show)}>
