...
export default function AllModals(props) {
  ...
  return (
    <div>
      ...
      <EditUserModal  setDataGridLoading={props.setDataGridLoading} setCheckShowGrid={props.setCheckShowGrid} apiRef={props.apiRef}  userData={props.userData} editUser={props.editUser}  />
