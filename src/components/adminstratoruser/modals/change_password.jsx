    ...
    if(userInfo && userInfo.token){
      ...
      if(formData.password === formData.confirmPassword){
        apiPost(url,params).then(response => {
          setIsLoading(false);
          document.getElementById("close_change_password_ad").click();
            ...
            <div className="modal-content">
              ...
              <form className="p-1" action="" onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className="modal-footer">
                  <button type="button" onClick={closePopup} className="btn bg-gradient-danger" id="close_change_password_ad" data-bs-dismiss="modal">Cancel</button>
