...
export default function BatchEditDistributor(props) {
  ...
  return (
    <>
      ...
      <div className="modal fade" id="batchEditdistributor" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="batchEditdistributorLabel" aria-hidden="true">
        <div className="modal-dialog modal-dialog-centered modal-lg">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title" id="batchEditdistributorLabel">
                Batch Edit
              </h5>
